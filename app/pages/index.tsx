  ...
  return (
    <div className="flex h-screen items-center justify-center flex-col">
      ...
      <div className="text-center">
        <p className="mb-4 ">By clicking <span className="text-blue-200">Yes</span>, you acknowledge that the information displayed on this website is not controlled by the creator, maintainer, a database or the website itself but is sourced directly from data on the Cardano blockchain.</p>
